...
export default function vehicleCard(props) {
    ...
    useEffect(() => {
        vehicleCardState.make === '' || vehicleCardState.model === '' || vehicleCardState.price === '' ?
    ...
    return (
        <div className="vehicle-card-div">
                ...
                editBtn ? (
                    <div>
                        <form onSubmit={editVehicleCard}>
                            ...
                            /><br />
                            <button disabled={disableBtn} type='submit'>Submit Changes</button>
                        </form>
                    </div>
                ) : (
                    <div>
            ...
            <button onClick={() => props.addToCart(vehicleCardState)}>Add to Cart</button>
